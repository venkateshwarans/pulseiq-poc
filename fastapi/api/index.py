...
# For Vercel deployment, we need to handle environment variables differently
# First try to get from environment variables directly (set in Vercel dashboard)
# If not available, try to load from .env.local file (for local development)
